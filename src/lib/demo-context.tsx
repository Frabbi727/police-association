...
const defaultNotices: Notice[] = [
  ...
  },
  {
    id: "NT-103",
    date: "2026-07-10",
    title: "Congratulations: Mosleh Uddin Ahmed Elected President",
    content: "The association expresses its warmest congratulations to CID Additional IG Mosleh Uddin Ahmed for being elected as the President of the Bangladesh Police Service Association. We look forward to strong representation and leadership.",
  ...
  },
  {
    ...
    content: "A formal statement was issued by the General Secretary Shamima Parveen condemning recent incident developments. The BPSA chief legal team is providing immediate representation and support.",
    category: "statement"
  },
  {
    id: "NT-106",
    date: "2026-07-03",
    title: "Congratulations: Shamima Parveen Elected General Secretary",
    content: "Congratulations to Superintendent of Police Shamima Parveen for her election as the General Secretary of the Bangladesh Police Service Association. We welcome her dedicated leadership and representation.",
    category: "congratulations"
  }
];
...
const translationDict: Record<string, string> = {
  ...
  "Mosleh Uddin Ahmed": "মোসলেহ উদ্দিন আহমদ",
  "Shamima Parveen": "শামীমা পারভীন",
  "Md. Abdullahhel Baki": "মোঃ আব্দুল্লাহেল বাকী",
  "Md. Daud Hossain": "মোঃ দাউদ হোসেন",
  "President, Bangladesh Police Service Association": "সভাপতি, বাংলাদেশ পুলিশ সার্ভিস অ্যাসোসিয়েশন",
  "General Secretary, Bangladesh Police Service Association": "সাধারণ সম্পাদক, বাংলাদেশ পুলিশ সার্ভিস অ্যাসোসিয়েশন",
  ...
  "Additional IG, CID": "অতিরিক্ত আইজিপি, সিআইডি",
  "Superintendent of Police": "পুলিশ সুপার",
  ...
  "Congratulations: Mosleh Uddin Ahmed Elected President": "অভিনন্দন: মোসলেহ উদ্দিন আহমদ সভাপতি নির্বাচিত",
  "The association expresses its warmest congratulations to CID Additional IG Mosleh Uddin Ahmed for being elected as the President of the Bangladesh Police Service Association. We look forward to strong representation and leadership.": "বাংলাদেশ পুলিশ সার্ভিস অ্যাসোসিয়েশনের নবনির্বাচিত সভাপতি হিসেবে সিআইডির অতিরিক্ত আইজি মোসলেহ উদ্দিন আহমদ নির্বাচিত হওয়ায় অ্যাসোসিয়েশন আন্তরিক অভিনন্দন জানাচ্ছে। আমরা তাঁর দূরদর্শী নেতৃত্বে সংগঠনের উত্তরোত্তর সাফল্য ও সমৃদ্ধি কামনা করছি।",
  ...
  "A formal statement was issued by the General Secretary Shamima Parveen condemning recent incident developments. The BPSA chief legal team is providing immediate representation and support.": "সাম্প্রতিক অনাকাঙ্ক্ষিত ঘটনার তীব্র নিন্দা জানিয়ে সাধারণ সম্পাদক শামীমা পারভীন একটি আনুষ্ঠানিক বিবৃতি জারি করেছেন। বিপিএসএ প্রধান আইনি দল আক্রান্ত কর্মকর্তাদের পাশে থেকে সম্পূর্ণ আইনি সহায়তা প্রদান করছে।",
  "Congratulations: Shamima Parveen Elected General Secretary": "অভিনন্দন: শামীমা পারভীন সাধারণ সম্পাদক নির্বাচিত",
  "Congratulations to Superintendent of Police Shamima Parveen for her election as the General Secretary of the Bangladesh Police Service Association. We welcome her dedicated leadership and representation.": "বাংলাদেশ পুলিশ সার্ভিস অ্যাসোসিয়েশনের সাধারণ সম্পাদক হিসেবে পুলিশ সুপার শামীমা পারভীন নির্বাচিত হওয়ায় আমাদের পক্ষ থেকে আন্তরিক অভিনন্দন ও শুভেচ্ছা।",
  "Newly Elected Committee of Bangladesh Police Service Association": "বাংলাদেশ পুলিশ সার্ভিস অ্যাসোসিয়েশনের নবনির্বাচিত কেন্দ্রীয় কার্যনির্বাহী কমিটি",
  "Newly Elected Committee": "নবনির্বাচিত কেন্দ্রীয় কমিটি",
  "The central executive committee for the term of 2026-2027.": "২০২৬-২০২৭ মেয়াদের নবনির্বাচিত কেন্দ্রীয় কার্যনির্বাহী কমিটি।",
  "President & Secretary": "সভাপতি ও সাধারণ সম্পাদক",
  "Committees Celebration Gallery": "কমিটি বরণ ও শুভেচ্ছা বিনিময় চিত্রশালা",
  "Formal reception and discussion at the executive office.": "কার্যনির্বাহী কার্যালয়ে আনুষ্ঠানিক বরণ ও আলোচনা সভা।",
  "Reception ceremony with flower bouquets at BPSA central office.": "বিপিএসএ কেন্দ্রীয় কার্যালয়ে ফুলেল শুভেচ্ছা ও বরণ অনুষ্ঠান।",
  "Signing Authority": "স্বাক্ষরকারী কর্তৃপক্ষ",
  "Date Published": "প্রকাশের তারিখ",
  "President Mosleh Uddin Ahmed and members of the board officially welcomed the graduating class of constables and sub-inspectors this week.": "সভাপতি মোসলেহ উদ্দিন আহমদ এবং বোর্ডের সদস্যবৃন্দ এই সপ্তাহে কনস্টেবল এবং উপ-পরিদর্শকদের নবীন ব্যাচকে আনুষ্ঠানিকভাবে স্বাগত জানিয়েছেন।",
  "Directing the association's strategic policy, welfare initiatives, and representation of BPSA members nationwide.": "সমগ্র দেশে বিপিএসএ সদস্যদের প্রতিনিধিত্ব, কল্যাণমূলক উদ্যোগ এবং অ্যাসোসিয়েশনের স্ট্র্যাটেজিক নীতি পরিচালনা করছেন।",
  "Coordinating administration, membership communications, regional committee alignments, and structural operations.": "অ্যাসোসিয়েশনের প্রশাসনিক কাজ, সদস্যদের সাথে যোগাযোগ, আঞ্চলিক কমিটিসমূহের সমন্বয় এবং সাংগঠনিক কার্যক্রম তদারকি করছেন।",
  ...
  "statement": "বিবৃতি",
  "notice": "নোটিশ",
  "Legal Defense": "আইনি সহায়তা",
  "Community Sports": "সামাজিক ও ক্রীড়া",
  "Education Grants": "শিক্ষা অনুদান",
  "24/7 Legal Shield": "২৪/৭ আইনি সুরক্ষা",
  "Youth & Outreach": "যুব ও সামাজিক কার্যক্রম",
  "Academic Scholarships": "শিক্ষাবৃত্তি",
  "BPSA Legal Defense Fund": "বিডিপিএ আইনি সহায়তা তহবিল",
  "Police-Youth Athletic League": "পুলিশ-যুব ক্রীড়া লীগ",
  "BDPA Educational Awards": "বিডিপিএ শিক্ষা সম্মাননা ও অনুদান",
  "Provides immediate, comprehensive legal representation for all active members. Our legal defense fund offers 24/7 coverage for incidents, disciplinary review hearings, and administrative inquiries.": "সকল সক্রিয় সদস্যের জন্য তাৎক্ষণিক এবং ব্যাপক আইনি প্রতিনিধিত্ব প্রদান করে। আমাদের আইনি প্রতিরক্ষা তহবিল যেকোনো ঘটনার তদন্ত এবং শুনানির জন্য ২৪/৭ সহায়তা নিশ্চিত করে।",
  "Engaging local youth through organized basketball and football leagues, community resource drives, and neighborhood safety campaigns to build mutual trust and positive community partnerships.": "পারস্পরিক বিশ্বাস এবং ইতিবাচক সামাজিক অংশীদারিত্ব গড়ে তোলার জন্য আয়োজিত বাস্কেটবল এবং ফুটবল লীগ, সামাজিক সম্পদ বিতরণ এবং প্রতিবেশী নিরাপত্তা প্রচারণার মাধ্যমে স্থানীয় যুবকদের সম্পৃক্ত করা।",
  "Empowering the children of our brave officers by offering merit-based higher education scholarships, tuition support grants, and school achievement congratulations recognitions.": "আমাদের সাহসী কর্মকর্তাদের সন্তানদের মেধাবী উচ্চশিক্ষা বৃত্তি, টিউশন সহায়তা অনুদান এবং কৃতিত্বপূর্ণ ফলাফলের জন্য অভিনন্দনের মাধ্যমে অনুপ্রাণিত করা।",
  "Hourly Coverage": "সার্বক্ষণিক কভারেজ",
  "24/7 Emergency Line": "২৪/৭ জরুরি হটলাইন",
  "Representation Cost": "আইনি প্রতিনিধিত্ব খরচ",
  "৳০ (100% Free for Members)": "৳০ (সদস্যদের জন্য ১০০% বিনামূল্যে)",
  "Annual Outreach": "বার্ষিক সামাজিক কার্যক্রম",
  "5,000+ Youths Reached": "৫,০০০+ যুবকের কাছে পৌঁছানো",
  "Complex Location": "ক্রীড়া কমপ্লেক্সের অবস্থান",
  "Sector 4 Sports Arena": "সেক্টর ৪ স্পোর্টস এরিনা",
  "Scholarship Grant": "শিক্ষা অনুদান পরিমাণ",
  "৳১০,০০০ - ৳৫০,০০০": "৳১০,০০০ - ৳৫০,০০০",
  "Scholarships Awarded": "প্রদত্ত বৃত্তির সংখ্যা",
  "1,200+ Students / Year": "বছরে ১,২০০+ শিক্ষার্থী",
  "Discount Card": "ডিসকাউন্ট কার্ড",
  "Smart Visitor Pass": "স্মার্ট ভিজিটর পাস",
  "Job Circulars": "চাকরি বিজ্ঞপ্তি",
  "Business Directory": "বিজনেস ডিরেক্টরি",
  "Police Mart": "পুলিশ মার্ট",
  "Discount Available": "ডিসকাউন্ট পাওয়া যাবে",
  "Select Fund Pool": "তহবিল নির্বাচন করুন",
  "Select Relief Fund Pool": "ত্রাণ তহবিল নির্বাচন করুন",
  "Natural Disasters Support Fund": "প্রাকৃতিক দুর্যোগ ত্রাণ তহবিল",
  "Medical Assistance Fund": "চিকিৎসা সহায়তা তহবিল",
  "Emergency Welfare Relief Fund": "জরুরি কল্যাণ অনুদান",
  "Donor Information": "দাতার বিবরণ",
  "Card Details": "কার্ডের বিবরণ",
  "Expiry (MM/YY)": "মেয়াদ উত্তীর্ণ (মাস/বছর)",
  "Street Address": "রাস্তার ঠিকানা",
  "ZIP / Postal Code": "জিপ / পোস্টাল কোড",
  "Donate": "দান করুন",
  "Processing Securely...": "নিরাপদে প্রসেস হচ্ছে...",
  "Charity Fund Accountability": "দাতব্য তহবিলের জবাবদিহিতা",
  "Secure Billing Details": "নিরাপদ বিলিং বিবরণ",
  "Tax Deduction Eligibility": "কর রেয়াত যোগ্যতা",
  "Transaction Receipt Summary": "লেনদেন রশিদ সারসংক্ষেপ",
  "Selected Fund": "নির্বাচিত তহবিল",
  "Merchant": "মার্চেন্ট",
  "Receipt ID": "রশিদ নম্বর",
  "Make Another Contribution": "আরেকটি অবদান রাখুন",
  "Thank You for Your Support!": "আপনার সমর্থনের জন্য ধন্যবাদ!",
  "We have successfully processed your tax-deductible donation of": "আমরা সফলভাবে আপনার কর-ছাড়যোগ্য অনুদান প্রসেস করেছি",
  " A confirmation receipt has been sent to your email.": " একটি নিশ্চিতকরণ রশিদ আপনার ইমেলে পাঠানো হয়েছে।",
  "Bangladesh Police Welfare Fund": "বাংলাদেশ পুলিশ কল্যাণ তহবিল",
  "Completed": "সম্পন্ন হয়েছে",
  "All Partners": "সকল পার্টনার",
  "Hospital & Clinics": "হাসপাতাল ও ক্লিনিক",
  "Restaurants": "রেস্তোরাঁ",
  "Travel & Lodging": "ভ্রমণ ও লজিং",
  "Retail & Stores": "খুচরা বিক্রেতা ও স্টোর",
  "Copy Code": "কোড কপি করুন",
  "Copied!": "কপি হয়েছে!",
  "OFF": "ছাড়",
  "Zoom Meetings": "জুম মিটিং",
  "QR Entry Pass": "কিউআর এন্ট্রি পাস",
  "Generate Office Entry Pass": "অফিস এন্ট্রি পাস তৈরি করুন",
  "Scan at Turnstile": "টার্নস্টাইলে স্ক্যান করুন",
  "Visitor / Officer Name": "ভিজিটর / অফিসারের নাম",
  "Purpose of Office Visit": "অফিস পরিদর্শনের উদ্দেশ্য",
  "Visiting Office Department": "পরিদর্শনকারী অফিস বিভাগ",
  "Office of General Secretary": "সাধারণ সম্পাদকের কার্যালয়",
  "Welfare Services Desk": "কল্যাণ সেবা ডেস্ক",
  "Treasury & Accounts": "কোষাধ্যক্ষ ও হিসাব",
  "Library & Archiving": "গ্রন্থাগার ও আর্কাইভ",
  "Generate QR Pass": "কিউআর পাস তৈরি করুন",
  "No Entry Pass Active": "কোনো এন্ট্রি পাস সক্রিয় নেই",
  "Submit the registration form on the left to generate your secure gate entrance QR code.": "আপনার সুরক্ষিত গেট প্রবেশের কিউআর কোড তৈরি করতে বাম দিকের ফর্মটি পূরণ করে সাবমিট করুন।",
  "Schedule Virtual Meeting (Zoom)": "ভার্চুয়াল মিটিং শিডিউল করুন (জুম)",
  "Book a direct Zoom video conference slot with BPA administrative committee desks.": "বিডিপিএ প্রশাসনিক কমিটির সাথে সরাসরি জুম ভিডিও কনফারেন্স স্লট বুক করুন।",
  "Meeting Agenda / Topic": "মিটিংয়ের এজেন্ডা / বিষয়",
  "Meeting Date & Time": "মিটিংয়ের তারিখ ও সময়",
  "Target Department": "টার্গেট বিভাগ",
  "Schedule Zoom Meeting": "জুম মিটিং শিডিউল করুন",
  "Active Video Conferences": "সক্রিয় ভিডিও কনফারেন্স",
  "Apply for Family Dependent Circular": "পরিবার নির্ভরশীল সার্কুলারে আবেদন করুন",
  "Applicant Full Name": "আবেদনকারীর পুরো নাম",
  "Relationship to Police Member": "পুলিশ সদস্যের সাথে সম্পর্ক",
  "Upload Resume (PDF / DOCX)": "জীবনবৃত্তান্ত আপলোড করুন (PDF / DOCX)",
  "Click to upload dependent CV file": "নির্ভরশীল প্রার্থীর জীবনবৃত্তান্ত আপলোড করতে ক্লিক করুন",
  "Submit Application": "আবেদন জমা দিন",
  "Submitting...": "জমা হচ্ছে...",
  "Application Sent": "আবেদন পাঠানো হয়েছে",
  "Apply Now": "আবেদন করুন",
  "Family Eligibility": "পরিবারের যোগ্যতা",
  "Search by title, role or keywords...": "শিরোনাম, পদবি বা কিওয়ার্ড দিয়ে খুঁজুন...",
  "Special Job Circulars": "বিশেষ নিয়োগ বিজ্ঞপ্তি",
  "Employment circulars specifically designated for police dependents and family members.": "বিশেষভাবে পুলিশ আশ্রীত ও পরিবারের সদস্যদের জন্য নির্ধারিত নিয়োগ বিজ্ঞপ্তি।",
  "Wife / Spouse": "স্ত্রী / স্বামী",
  "Son": "পুত্র",
  "Daughter": "কন্যা",
  "Brother": "ভাই",
  "Sister": "বোন",
  "Police Members' Business Directory": "পুলিশ সদস্যদের ব্যবসায়িক তালিকা",
  "Support businesses owned, run, or managed by Bangladesh Police members and their immediate families.": "বাংলাদেশ পুলিশ সদস্য এবং তাদের পরিবারের মালিকানাধীন ও পরিচালিত ব্যবসায়িক প্রতিষ্ঠানসমূহকে সমর্থন করুন।",
  "All Businesses": "সকল ব্যবসায়",
  "Catering & Food": "ক্যাটারিং ও খাদ্য",
  "Logistics & Delivery": "লজিস্টিকস ও ডেলিভারি",
  "IT & Technical": "আইটি ও কারিগরি",
  "Garments & Apparel": "গার্মেন্টস ও পোশাক",
  "Owned by": "মালিকানাধীন",
  "Request Inquiry": "অনুসন্ধানের অনুরোধ",
  "Connected": "সংযুক্ত হয়েছে",
  "Connecting...": "সংযুক্ত হচ্ছে...",
  "Official Police Mart & Merchandise": "অফিসিয়াল পুলিশ মার্ট ও মার্চেন্ডাইজ",
  "Purchase official association apparel, accessories, and collectibles. All proceeds go to the Welfare Fund.": "অফিসিয়াল অ্যাসোসিয়েশনের পোশাক, এক্সেসরিজ এবং সংগ্রহযোগ্য আইটেম কিনুন। সমস্ত আয় কল্যাণ তহবিলে জমা হয়।",
  "Add to Cart": "কার্টে যোগ করুন",
  "Shopping Cart": "শপিং কার্ট",
  "Your Cart is Empty": "আপনার শপিং কার্ট খালি",
  "Add official merchandise items from the catalog.": "ক্যাটালগ থেকে অফিসিয়াল মার্চেন্ডাইজ আইটেম যোগ করুন।",
  "Subtotal": "উপমোট",
  "Grand Total": "সর্বমোট",
  "Place Store Order": "অর্ডার সম্পন্ন করুন",
